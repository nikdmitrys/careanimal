...
const { color_main_green, color_main_orange, color_placeholder, color_white } =
	colors;
		...
		<Wrapper>
			...
			<DescriptionWrapper>
				<DescriptionContainer>
					...
					<div></div>
					<h2>
						ПРОЕКТ, КОТОРЫЙ СОЗДАН ДЛЯ ПОМОЩИ
						<br />
						ДОМАШНИМ ПИТОМЦАМ И ИХ ХОЗЯЕВАМ.
					</h2>
				</DescriptionContainer>
			</DescriptionWrapper>
			<DescriptionContainer>
				...
				<Description>
					<p>
						Наша умная доска объявлений поможет найти пропавших собак и кошек.
					</p>
					<p>
						Вы также можете найти расположение ближайших Зоомагазинов
						<br /> и ветеринарных клиник.
					</p>
			...
			<Container>
				<Ads>
					...
					<Ad color={color_main_orange}>
						<AdImg img={cat} />
						<AdInfo>
							<h3>нашли чужого питомца</h3>
							<p>Создать объявление о находке питомца, чтобы все увидели</p>
							<AdButton href='/profile/createAd'>создать объявление</AdButton>
						</AdInfo>
					</Ad>
				</Ads>
				<FoundWrapper>
					...
					<Map>
						<GMap
							stray={props.announcements_stray}
							house={props.announcements_house}
							width={1102}
							height={615}
							searchStyle={{
								paddingLeft: '48px',
			...
			<Subscribe>
				<Container>
					...
					<p>
						И будьте в курсе всех событий и новостей о пропаже и находке
						питомцев
					</p>
					<InputContainer>
			...
			<MotivationContainer>
				...
				<MotivationTextContainer>
					...
					<p>Возможно, питомец, которого вы ищете, находится где-то рядом!</p>
				</MotivationTextContainer>
			</MotivationContainer>
		</Wrapper>
	);
