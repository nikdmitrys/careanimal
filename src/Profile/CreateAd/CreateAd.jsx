...
import {
	...
	Input,
	RadioInput,
} from '../../components/forms/form_controls';
import {
	file_required,
	radio_required,
	required,
...
const CreateForm = reduxForm({ form: 'ResumeInfo' })(props => {
				...
				<RadioButtonsContainer>
					...
					<RadioOther htmlFor='other' color={color_main_orange}>
						...
						<Field
							component={RadioInput}
							onChange={() => {
								set_other_input_required([required]);
							}}
							type='radio'
							id='other'
							name='animal'
			...
			<FormItem>
				...
				<FormMap>
					<Field
						...
						validate={[required]}
						name={'address'}
						placeholder='Введите адрес пропажи:'
					/>
					<Map
						width={680}
						height={430}
			...
			<FormItem>
				...
				<TypeContainer>
					...
					<Field
						...
						validate={[radio_required]}
					/>
					<label htmlFor='stray'>Бездомный</label>
				</TypeContainer>
			</FormItem>
			<FormItem>
